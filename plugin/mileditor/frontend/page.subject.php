...
<?php
	if(isset($_GET['id'])){
		...
		//selected subject coloring
		echo "<script>";
		echo "jQuery(document).ready(function() {";
		echo "jQuery('#" . $td_id . "').addClass('clicked'); });";
		echo "console.log('coloring at " . $td_id . "');";
		echo "</script>";
	} else {
		$td_id = null;
	}
...
?>
	...
	<div class="setting_block_right">
		<form id="mil_create_subject_form">
			...
			<button type="button" class="mil_btn mil_blue_btn mil_modify_subject_button">과목 설정</button>
